...
import type { Except } from "type-fest";
  import { Z_INDEXES } from "mui-tiptap";
import MenuButton, { type MenuButtonProps } from "./MenuButton";w
  
  export interface MenuButtonFindAndReplaceProps
  ...
  export function ColorPickerPopperBody({
    ...
    // be useful to tweak a color from a swatch beafore saving.)
  ...
  export function MenuButtonFindAndReplace({
    value: colorValue,
    onChange,
    swatchColors,
    labels,
